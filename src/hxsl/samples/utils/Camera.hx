...
class Camera {
    ...
    public var pos : HXSLVector;
    public var up : HXSLVector;
    public var target : HXSLVector;
    ...
    public function new( fov = 60., zoom = 1., ratio = 1.333333, zNear = 0.02, zFar = 40. ) {
        ...
        this.zNear = zNear;
        this.zFar = zFar;
        pos = new HXSLVector(2, 3, 4);
        up = new HXSLVector(0, 0, -1);
        target = new HXSLVector(0, 0, 0);
        m = new Matrix();
        mcam = new Matrix();
        update();
    }
