...
// 3x4 multiply by default
    ...
    public inline function project( v : HXSLVector, out : HXSLVector ) {
    ...
    public inline function transform( v : HXSLVector, out : HXSLVector ) {
        var px = _11 * v.x + _21 * v.y + _31 * v.z + _41;
        var py = _12 * v.x + _22 * v.y + _32 * v.z + _42;
        var pz = _13 * v.x + _23 * v.y + _33 * v.z + _43;
        out.x = px;
    ...
    public function toMatrix() {
        return new flash.geom.Matrix3D(Vector.ofArray([
        _11, _12, _13, _14,
        _21, _22, _23, _24,
        _31, _32, _33, _34,
        _41, _42, _43, _44,
